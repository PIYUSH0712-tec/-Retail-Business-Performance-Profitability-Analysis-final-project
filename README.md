...
Analyze revenue, profit margins, and inventory behavior
...
Python (Pandas): Correlation and exploratory data analysis
...
Calculated revenue, profit, and profit margins by category and sub-category

Performed correlation analysis in Python to study inventory vs profitability

Exported analytical results for visualization

Built an interactive Tableau dashboard with filters for region, product type, and season
...
Report/ – Final PDF report with insights
...
Overstocked or slow-moving items negatively impact profitability
...
LinkedIn: linkedin.com/in/piyush-bidwaikar 
